        ...
        <div>
            <div className="bg_home_container">
                <div className="video-container">
                    ...
                    <div className="search_card d-flex flex-wrap justify-content-center align-items-center gap-3">
                        <div
                            style={{
                                width: "200px",
                                background: "white",
                ...
                <div className="self-container d-flex flex-wrap justify-content-center gap-4 mt-5 mb-5 px-3">
                ...
                <div id='Popular_destinations'>
                    <div className="popular_destinations">
                        ...
                        <div className="popular_destinations d-flex flex-wrap justify-content-center gap-4 mb-5 p-3 p-md-5">
                ...
                <div id='Why_travel_Us'>
                    <div className='why_Travel_Us'>
                        ...
                        <div className='Travel_us_card d-flex flex-wrap justify-content-center gap-4 mb-5 mt-5'>
                            ...
                            <div className='trav_card d-flex flex-column justify-content-center align-items-center text-center p-3'>
                                ...
                                <p className='trav_text'>Tailor-made itineraries for you.</p>
                            </div>
